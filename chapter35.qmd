...
このような再現性の確保、計算結果の共有のためのライブラリが[**R markdown**](https://rmarkdown.rstudio.com/)[@Yihui_Xie_231230]です。R markdownでは、マークアップ言語である**Markdown**を用いて、Rのコードとその説明文を同時に文書として作成することができます。
...
以下ではR markdownについて説明していきますが、RstudioではQuartoもR markdownと同様に用いることができます。
