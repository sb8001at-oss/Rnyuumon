...
このような再現性の確保、計算結果の共有のためのライブラリが[**R markdown**](https://rmarkdown.rstudio.com/)[@rmarkdown_bib1; @rmarkdown_bib2; @rmarkdown_bib3]です。R markdownでは、マークアップ言語である**Markdown**を用いて、Rのコードとその説明文を同時に文書として作成することができます。
