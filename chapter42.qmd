...
Quartoでは、**QuartoのProject**というものを設定することができます。Rstudioを用いる場合、Quarto Projectは[36章](chapter36.qmd#projectの設定)で説明したRstudioのProjectとほぼ同じです。RstudioではProjectを作成するとき、Projectのタイプを選択することができます。
