...
```{txt, filename="パイプ演算子の利用と改行・インデント"}
# 良い例
iris |> 
  group_by(Species) |> 
...
```{txt, filename="パイプ演算子の入れ子（ネスト）は避ける"}
# 良い例
