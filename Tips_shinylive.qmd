...
上記の方法で`shinylive`を用いたShinyアプリをデプロイしたのが以下のリンクです。Github Pagesではなく、[Claudflare Pages](https://www.cloudflare.com/ja-jp/developer-platform/products/pages/)というサービスでデプロイしています。

<https://362e47f7.shinylive-example.pages.dev/site/>

<https://timeline-e61.pages.dev/>
