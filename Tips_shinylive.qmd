...
WebRの取り扱いにはJavascriptやNode.jsについての知識が必要で、それほど簡単に利用することはできません。しかし、WebRを[Quarto](Chapter36.qmd)で用いるQuarto Extensionである`quarto-webr`はJavascriptの知識がないRユーザーでも簡単に利用することができます。
